    ...
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-primary-dark text-white px-6">
        ...
        >
          ...
          <p className="text-lg font-medium mb-4">正在寻找你的横断山兽...</p>
      ...
      <div className="flex-1 px-5 py-6 flex flex-col max-w-lg mx-auto w-full">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Question text */}
            <h2 className="text-xl font-bold text-text-primary mb-2 leading-snug">
              {question.text}
            </h2>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-text-muted mt-0.5">{opt.en}</p>
                      </div>
                      {isSelected && (

    ...
    <div className="min-h-dvh">
      ...
      <div className="min-h-dvh flex flex-col items-center justify-center relative px-4 pt-12 pb-8" style={{ background: theme.heroBg }}>
        ...
        <div className="absolute top-0 left-0 right-0 flex justify-between items-center px-4 py-3">
          <div className="flex items-center gap-1.5 bg-white/10 rounded-full px-2.5 py-1 cursor-pointer hover:bg-white/20 transition-colors" onClick={() => navigate('/')}>
            <span className="text-xs">🐾</span>
            <span className="font-mono text-[10px] text-white/90 tracking-wide">HDTI</span>
            <span className="w-px h-2.5 bg-white/20" />
            <span className="text-[10px] text-white/60">首页</span>
          </div>
